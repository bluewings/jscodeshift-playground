...
type StandaloneSourceEditor = Parameters<Required<ComponentProps<typeof Editor>>['onMount']>[0];
type StandaloneCodeMonaco = Parameters<Required<ComponentProps<typeof Editor>>['onMount']>[1];

function SourceEditor(props: ISourceEditorProps) {
  ...
  const editorRef = useRef<StandaloneSourceEditor>();
